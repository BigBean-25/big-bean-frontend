...
export const metadata: Metadata = {
  title: 'Brewing Tools | Big Bean Café',
  description: 'Shop coffee brewing tools and café essentials from Big Bean Café.',
  alternates: { canonical: 'https://www.bigbeancafe.in/brewing-tools' },
}
...
export default async function BrewingToolsPage() {
      ...
      <main className="min-h-screen bg-[#F7EFE7]">
        <div className="mx-auto max-w-6xl px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="mt-1 text-3xl font-black text-[#3D1F0D]">Brewing Tools</h1>
            <p className="mt-2 text-sm text-[#9B6B50]">
              Coffee brewing tools and café essentials for the perfect home brew.
            </p>
          </div>
          ...
          {products.length === 0 ? (
            <div className="rounded-[30px] border border-[#E6C7A8] bg-white px-6 py-20 text-center">
              ...
              <p className="mt-2 text-sm text-[#9B6B50]">
                Brewing tools and equipment will be available soon.
              </p>
              <Link
                href="/merchandise"
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-2 flex items-end gap-2">
                        <span className="text-lg font-black text-[#3D1F0D]">₹{price.toFixed(0)}</span>
                        {mrp && mrp > price && (
                          <span className="pb-0.5 text-sm text-[#A98A74] line-through">₹{mrp.toFixed(0)}</span>
                        )}
                      </div>
                    </div>
                  </Link>
