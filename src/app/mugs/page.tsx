...
export const metadata: Metadata = {
  title: 'Mugs | Big Bean Café',
  description: 'Shop Big Bean Café mugs and drinkware for your daily coffee moments.',
  alternates: { canonical: 'https://www.bigbeancafe.in/mugs' },
}
      ...
      <main className="min-h-screen bg-[#F7EFE7]">
        <div className="mx-auto max-w-6xl px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="mt-1 text-3xl font-black text-[#3D1F0D]">Big Bean Café Mugs</h1>
            <p className="mt-2 text-sm text-[#9B6B50]">
              Premium mugs and drinkware for your daily coffee moments.
            </p>
          </div>
          ...
          {products.length === 0 ? (
            <div className="rounded-[30px] border border-[#E6C7A8] bg-white px-6 py-20 text-center">
              ...
              <p className="mt-2 text-sm text-[#9B6B50]">Mugs and drinkware will be available soon.</p>
              <Link
                href="/merchandise"
